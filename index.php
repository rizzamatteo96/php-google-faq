...
<?php 
  $navBarLinks = ['Introduzione','Norme sulla privacy','Termini di servizio','Tecnologie','Domande frequenti'];
...
<body>
  ...
  <header class="position-fixed top-0 start-0 end-0 bg-light">
    <div class="top my-2 d-flex justify-content-between px-5">
      ...
      <div>
        <img id="logo" src="https://loghi-famosi.com/wp-content/uploads/2020/09/Google-Logo.png" alt="logo google">
  ...
  <main class="mt-150">
    <div class="ms-container text-wrap">
      <?php foreach($qea as $question => $answers){ ?>
        <h2 class="fs-4 fw-bold"><?php echo $question; ?></h2>
